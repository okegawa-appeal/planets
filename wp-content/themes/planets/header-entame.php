...
<body <?php body_class(); ?>>
	...
	<div class="inner cf">
			...
			<div class="site-title"><a href="<?php echo esc_url( home_url( '/entame/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/entame.jpg"></a></div>
	...
	<?php 
	if (ends_with($_SERVER['REQUEST_URI'], 'entame')) {
