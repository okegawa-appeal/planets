...
$page_title          = sprintf( __( '%s List', 'favorite' ), $favorite_option['label_name'] ); // phpcs:ignore
$page_title          = apply_filters( 'usces_theme_filter_page_title', $page_title, $favorite_option['label_name'] );
$no_favorite_message = sprintf( __( 'There are no %s items.', 'favorite' ), $favorite_option['label_name'] ); // phpcs:ignore
